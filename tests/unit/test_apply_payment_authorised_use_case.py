"""Unit tests for Broker application of payment authorisation outcomes."""
...
async def test_broker_applies_payment_authorisation_to_customer_visible_state() -> None:
    """Verify Broker updates stored ride state after PaymentAuthorised."""
    ...
    use_case = ApplyPaymentAuthorisedUseCase(status_store=store)
