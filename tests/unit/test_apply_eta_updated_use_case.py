...
async def test_broker_applies_eta_feedback_to_customer_visible_state() -> None:
    """Verify Broker updates stored ride state after EtaUpdated."""
    ...
    use_case = ApplyEtaUpdatedUseCase(status_store=store)
