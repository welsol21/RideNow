...
- [x] 2A.2 ACC-RED - happy-path service-connectivity integration slice
- [x] 2A.3 ACC-RED - failure-path service-connectivity integration slice
- [x] 2A.4 ACC-RED - manual-demo-mode integration slice
- [x] 2A.5 UNIT-GREEN - minimum topology wiring to make the first full-system integration test pass
- [x] 2A.6 REFACTOR
- [x] 2A.7 PHASE 2A GATE - named operating-mode connectivity established
- [x] 2A.8 Write docs/state/PHASE_2A_DONE.md

## Phase 3 - Port Contracts & In-Memory Adapters

- [x] 3.1 Define outbound ports for generated services
- [x] 3.2 UNIT-RED - shared contract suite per port
...
- [x] 4.1.7 ACC-GREEN
- [x] 4.1.8 Run all prior acceptance tests
- [x] 4.1.9 ACC-REFACTOR
- [x] 4.1.10 Write docs/state/STORY_request-ride-acknowledgement_DONE.md

### 4.2 Story: driver-assigned
- [x] 4.2.0 Write docs/state/STORY_driver-assigned_START.md
- [x] 4.2.1 ACC-RED
- [x] 4.2.2 Confirm failure reason
- [x] 4.2.3 UNIT-RED
- [x] 4.2.4 UNIT-GREEN
- [x] 4.2.5 UNIT-REFACTOR
- [x] 4.2.6 Repeat inward TDD until acceptance is green
- [x] 4.2.7 ACC-GREEN
- [x] 4.2.8 Run all prior acceptance tests
- [x] 4.2.9 ACC-REFACTOR
...
- [x] 4.4.0 Write docs/state/STORY_payment-authorised_START.md
- [x] 4.4.1 ACC-RED
- [x] 4.4.2 Confirm failure reason
- [x] 4.4.3 UNIT-RED
- [x] 4.4.4 UNIT-GREEN
- [x] 4.4.5 UNIT-REFACTOR
- [x] 4.4.6 Repeat inward TDD until acceptance is green
- [x] 4.4.7 ACC-GREEN
- [x] 4.4.8 Run all prior acceptance tests
- [x] 4.4.9 ACC-REFACTOR
- [x] 4.4.10 Write docs/state/STORY_payment-authorised_DONE.md

### 4.5 Story: trip-progress
- [x] 4.5.0 Write docs/state/STORY_trip-progress_START.md
- [x] 4.5.1 ACC-RED
- [x] 4.5.2 Confirm failure reason
- [x] 4.5.3 UNIT-RED
- [x] 4.5.4 UNIT-GREEN
- [x] 4.5.5 UNIT-REFACTOR
- [x] 4.5.6 Repeat inward TDD until acceptance is green
- [x] 4.5.7 ACC-GREEN
- [x] 4.5.8 Run all prior acceptance tests
- [x] 4.5.9 ACC-REFACTOR
...
- [x] 4.7.0 Write docs/state/STORY_no-driver-available_START.md
- [x] 4.7.1 ACC-RED
- [x] 4.7.2 Confirm failure reason
- [x] 4.7.3 UNIT-RED
- [x] 4.7.4 UNIT-GREEN
- [x] 4.7.5 UNIT-REFACTOR
- [x] 4.7.6 Repeat inward TDD until acceptance is green
- [x] 4.7.7 ACC-GREEN
- [x] 4.7.8 Run all prior acceptance tests
- [x] 4.7.9 ACC-REFACTOR
